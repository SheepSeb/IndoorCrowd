...
def main() -> int:
    ...
    # Paths
    parser.add_argument("--raw-frames-dir", type=Path, default=Path("dataset/raw_frames_5fps"))
    parser.add_argument("--output-dir",     type=Path, default=Path("dataset/MOT_labels_sam3_botsort_5fps"))
    ...
    parser.add_argument("--frame-rate", type=int, default=FRAME_RATE,
    ...
    if not args.raw_frames_dir.exists():
        print(f"ERROR: raw frames dir not found: {args.raw_frames_dir}", file=sys.stderr)
        return 1
